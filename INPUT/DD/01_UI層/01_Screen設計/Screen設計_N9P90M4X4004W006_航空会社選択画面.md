# Screen設計 N9P90M4X4004W006_航空会社選択画面

- 関連ドキュメント
  - [外部設計書_N9P90M4X4004W006_航空会社選択画面](../N9P90M4X4004W006_航空会社選択画面.md)
...
|項目名|型|説明|
|---|---|---|
|screenUiData|[X4004W006ScreenUiData](../../04_Class設計/DataClass設計_X4004W006ScreenUiData.md)|画面のUI状態を操作する画面固有のViewModelクラスのUIData|
|onClickKokuKaishaButton|(String) -&gt; Unit|航空会社リスト内ボタン押下時|
...
|headerProps.title|MP90ARIM40016|-|
...
|---|---|---|
|useDivider|false|-|
|buttons|-|個数 : screenUiData.kokuKaishaList.size|
|buttons[index].type|NpButtonType.PRIMARY|-|
|buttons[index].label|screenUiData.kokuKaishaList[index]|-|
|buttons[index].enabled|true|-|
|buttons[index].onClick|onClickKokuKaishaButton|-|
